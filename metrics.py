...
def Semantic_Fidelity(cosine, countNouns, countObjects):
    ...
    metric2 = cosine ** ((countObjects / countNouns)/(max(countObjects,countNouns)**(0.5)+1))
    metric3 = cosine * ((countNouns / countObjects)/(max(countObjects,countNouns)+1))
    metric4 = cosine * ((countNouns / countObjects)/(max(countObjects,countNouns)**(0.5)+1))
